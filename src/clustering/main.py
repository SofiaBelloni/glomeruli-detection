...
#
#n_glomeruli = get_n_glomeruli(dataset, labels)
#n_glomeruli_labels = get_n_glomeruli_labels(dataset, labels)
...
#np.save("../../dataset512x512/glomeruli_features_res.npy", res)
#glomeruli_features = tf.keras.layers.GlobalAveragePooling2D()(res)
#
#np.save("../../dataset512x512/glomeruli_features_resnet.npy", glomeruli_features)
#print("Glomeruli features shape:", glomeruli_features.shape)

glomeruli_features=np.load("../../dataset512x512/glomeruli_features_resnet.npy")

run_clustering(glomeruli_data, glomeruli_features, "resnet50", "resnet50")

glomeruli_features_pca = PCA(n_components=100).fit_transform(glomeruli_features)

run_clustering(glomeruli_data, glomeruli_features_pca, "resnet50_pca", "resnet50")
