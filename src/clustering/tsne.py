...
def define_best_params_tsne(dataset):
    ...
    best_params_silhouette = max(
        tsne_results, key=lambda x: x['silhouette_score'])['params']
    best_params_calinski_harabasz = max(
        tsne_results, key=lambda x: x['calinski_harabasz_score'])['params']
    best_params_davies_bouldin = min(
        tsne_results, key=lambda x: x['davies_bouldin_score'])['params']
